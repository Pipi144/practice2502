 ...
 return (
  <div className="myInfo" id="profileSection">
   ...
   <div className="myPortfolio">
    <h2 style={{color: "gray", letterSpacing: "1px", fontFamily: "fantasy"}}>About Me</h2>

    <p>{aboutMeText}</p>
   </div>
   <img className="ui medium circular image" src={require("./pic/profile.jpg")} style={{border: "5px solid lightblue"}}></img>
   <div className="myPortfolio">
    <h2 style={{letterSpacing: "1px", fontFamily: "fantasy", color: "gray"}}>My Personal Detail</h2>
    <h3><bold>Name:</bold></h3>
    <p>Phat Minh Thanh Truong  (Pipi)</p>
    <h3><bold>Date of Birth</bold></h3>
    <p>14/04/1993</p>
    <h3><bold>Nationality:</bold></h3>
    <p>Viet nam</p>
    <h3><bold>Current Adress:</bold></h3>
    <p>Kings Park, VIC 3021, Australia</p>
    <h3><bold>Hobbies:</bold></h3>
