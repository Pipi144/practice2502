    ...
    <Carousel style={{width: "100%"}} activeIndex={index} onSelect={handleSelect} fade>
        <Carousel.Item style={{width: "100%", height: "550px"}}>
          <img
            ...
            src={require("./pic/carousel1.jpg")} style={{borderRadius: "25px", height: "550px"}}
            alt="First slide"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item style={{width: "100%", height: "550px"}}>
          <img
            className="d-block w-100"
            src={require("./pic/carousel2.jpeg")} style={{borderRadius: "25px", height: "550px"}}
            alt="First slide"
          />
          <Carousel.Caption>
            <h1>First Job in Australia in 2016</h1>
            <p>From waiter to barista to supervisor in 3.5 years, during time at school</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item style={{width: "100%", height: "550px"}}>
          <img
            className="d-block w-100"
            src={require("./pic/BI Degree.jpeg")} style={{borderRadius: "25px", height: "550px"}}
            alt="First slide"
          />
          <Carousel.Caption>
